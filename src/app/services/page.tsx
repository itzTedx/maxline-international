...
export default function ServicesPage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section aria-label="Services list" className="container space-y-12 py-12 md:space-y-24 md:py-20">
          ...
          >
            <div className="order-2 md:order-1 md:col-span-7 md:p-6 md:group-even:order-2">
              <div className="flex items-center gap-4 md:gap-6">
                ...
                <h3 className="font-medium text-2xl md:text-4xl">{service.title}</h3>
              </div>
