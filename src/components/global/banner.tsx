...
export const Banner = ({ data }: Props) => {
  return (
    <section className="relative m-3">
      <div className="relative overflow-clip rounded-3xl bg-gradient-to-b from-sky-950 to-[#062438] py-6 text-white max-md:pb-3 md:pb-12 md:pt-32">
        <div className="container relative z-10 grid gap-4 md:grid-cols-2 md:gap-12">
          ...
          <div className="space-y-4 max-md:pb-4 md:py-10">
            <h1 className="text-2xl font-semibold !leading-snug md:text-5xl">
              {data.title}
            </h1>
