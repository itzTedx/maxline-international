      ...
      <NavigationMenuLink asChild>
        ...
        >
          ...
          <div className="space-y-1 p-4">
            ...
            <h2 className="pb-3 font-medium font-poly-sans text-lg leading-none">{data.title}</h2>
      ...
      <NavigationMenuList aria-label="Main menu">
        ...
        {Object.entries(staticLinks).map(([, item]) => (
          <NavigationMenuItem key={item.href} onMouseEnter={() => handleHoverButton(item.href)}>
            <NavigationMenuLink asChild>
              <Link className={cn(navigationMenuTriggerStyle(), "relative")} href={item.href}>
                {item.title}
        ...
        <NavigationMenuItem className="relative" onMouseEnter={() => handleHoverButton("company")}>
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    <div className="space-y-2 p-4">
                      ...
                      <h2 className="pb-3 font-medium font-poly-sans text-lg leading-none">About us</h2>
                    </div>
                  </Link>
                </NavigationMenuLink>
              </li>
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    <div className="space-y-2 p-4">
                      ...
                      <h2 className="pb-3 font-medium font-poly-sans text-lg leading-none">Gallery</h2>
                    </div>
                  </Link>
                </NavigationMenuLink>
              </li>
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    <div className="space-y-2 p-4">
                      ...
                      <h2 className="pb-3 font-medium font-poly-sans text-lg leading-none">Our Team</h2>
                    </div>
                  </Link>
                </NavigationMenuLink>
              </li>
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    <div className="space-y-2 p-4">
                      ...
                      <h2 className="pb-3 font-medium font-poly-sans text-lg leading-none">Blogs & News</h2>
                    </div>
                  </Link>
                </NavigationMenuLink>
              </li>
        ...
        <NavigationMenuItem className="relative" onMouseEnter={() => handleHoverButton(distributions.href)}>
          <NavigationMenuTrigger>
            <NavigationMenuLink asChild>
        ...
        <NavigationMenuItem className="relative" onMouseEnter={() => handleHoverButton(tradings.href)}>
          <NavigationMenuTrigger>
            ...
            <div className="mx-auto grid grid-cols-8 md:w-dvw lg:w-6xl">
              ...
              <div className="col-span-2 flex h-full w-full border-l border-l-sky-100 p-4">
                <div className="flex w-full flex-col justify-end rounded-xl bg-sky-100 p-4">
                  ...
                  <h2 className="pb-4 font-medium font-poly-sans text-lg leading-none">{tradings.title}</h2>
        ...
        {/* Services section */}
        <NavigationMenuItem className="relative" onMouseEnter={() => handleHoverButton(services.href)}>
          <NavigationMenuTrigger>
            <NavigationMenuLink asChild className="py-3">
