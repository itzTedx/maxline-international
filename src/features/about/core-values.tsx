...
export const CoreValues = () => {
  return (
    <section
      id="core-values"
      className="container grid gap-3 md:grid-cols-6 md:gap-9"
    >
      <AnimatedCard
      ...
      >
        ...
        <ul className="grid gap-4 md:grid-cols-2 md:gap-9">
          {CORE_VALUES.map((value, i) => (
            <li
              key={value.title}
              className="space-y-1.5 rounded-2xl border border-white bg-white/60 p-1 md:p-6"
            >
