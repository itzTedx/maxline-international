...
export const Brands = () => {
  return (
    <section id="brands">
      ...
      <div className="relative -mt-32 h-96 overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#38BDF8,transparent_70%)] before:opacity-30 after:absolute after:-left-1/2 after:top-1/2 after:aspect-[1/0.7] after:w-[200%] after:rounded-[100%] after:border-t after:border-[#7876c566] after:bg-sky-100">
        <Sparkles
          density={1200}
