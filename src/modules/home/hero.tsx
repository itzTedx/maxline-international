...
export const Hero = () => {
  return (
    <div className="relative" itemScope itemType="https://schema.org/Organization">
      <section aria-label="Main hero section" className="m-3 overflow-hidden rounded-3xl" id="hero" role="banner">
        <HeroVideo />
        <div className="md:-mt-60 w-full pb-9">
          <div className="container relative z-10 grid items-center gap-3 rounded-2xl bg-white px-9 py-6 lg:grid-cols-4 lg:gap-6">
            ...
            <div className="space-y-4">
              ...
              <Button asChild className="w-full bg-linear-to-b" variant="primary">
        ...
        <div className="item group relative flex flex-col justify-between overflow-clip rounded-2xl p-4 md:col-span-5 md:p-8">
          <div className="z-10 flex items-center justify-between pb-4 md:pb-0">
            <div className="rounded-full bg-white p-1 md:p-2">
              <IconGoogle aria-label="Google icon" className="size-5 md:size-auto" />
            </div>
          ...
          <div className="z-10 flex items-end justify-between">
            <div itemProp="reviewRating" itemScope itemType="https://schema.org/Rating">
              <span className="flex items-center space-x-1.5">
                <p className="font-medium font-poly-sans text-2xl md:text-3xl" itemProp="ratingValue">
                  4.0
                </p>
                <IconStarFilled aria-label="Star rating" className="size-4 text-yellow-400 md:size-5" />
              </span>
            </div>
            <AvatarGroup />
          </div>
