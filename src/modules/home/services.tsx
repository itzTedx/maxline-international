...
const ServicesHero = memo(() => (
  <div className="container grid gap-4 py-12 md:grid-cols-2 md:gap-12 md:py-24">
    <h2 className="text-balance text-2xl leading-tight md:text-5xl">
      Comprehensive ICT, ELV & AV Solutions for{" "}
      <AuroraText isDark>Every Industry</AuroraText>
    </h2>
    <p className="font-light leading-relaxed md:text-xl">
      We offer a comprehensive range of ICT, ELV, and AV products from globally
      recognized brands:
    </p>
  </div>
));
...
export const Services = memo(() => (
  <section
    id="services"
    className="relative overflow-clip bg-[#032033] text-white"
